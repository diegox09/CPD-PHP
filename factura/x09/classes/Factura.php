...
class Factura extends mysqli {
	...
	public function insert_factura($numeroFactura, $ciudad, $fecha, $fechaActual, $idCliente, $nit, $nombres, $telefono, $direccion, $idUser, $idEstadoFactura, $descripcion, $valor, $tarifaIva, $observaciones) {		
        return $this->query('INSERT INTO factura (numeroFactura, ciudad, fecha, fechaActualizacion, idCliente, nit, nombres, telefono, direccion, idUser, idEstadoFactura, descripcion, valor, tarifaIva, observaciones) VALUES("'.$numeroFactura.'", "'.$ciudad.'", "'.$fecha.'", "'.$fechaActual.'", "'.$idCliente.'", "'.$nit.'", "'.$nombres.'", "'.$telefono.'", "'.$direccion.'", "'.$idUser.'", "'.$idEstadoFactura.'", "'.$descripcion.'", "'.$valor.'", "'.$tarifaIva.'", "'.$observaciones.'")');
    }
		
	public function update_factura($numeroFactura, $ciudad, $fecha, $fechaActual, $idCliente, $nit, $nombres, $telefono, $direccion, $idUser, $idEstadoFactura, $descripcion, $valor, $tarifaIva, $observaciones) {				
       return $this->query('UPDATE factura SET ciudad = "'.$ciudad.'", fecha = "'.$fecha.'", fechaActualizacion = "'.$fechaActual.'", idCliente = "'.$idCliente.'", nit = "'.$nit.'", nombres = "'.$nombres.'", telefono = "'.$telefono.'", direccion = "'.$direccion.'", idUser = "'.$idUser.'", idEstadoFactura = "'.$idEstadoFactura.'", descripcion = "'.$descripcion.'", valor = "'.$valor.'", tarifaIva = "'.$tarifaIva.'", observaciones = "'.$observaciones.'" WHERE numeroFactura = "'.$numeroFactura.'"');
    }			
}
?>
