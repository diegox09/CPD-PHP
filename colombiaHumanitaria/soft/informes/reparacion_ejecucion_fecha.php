...
$objPHPExcel->getActiveSheet()->getStyle('A1:L'.$contador)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
		...
		$objPHPExcel->getActiveSheet()->getStyle('F2:G'.$contador)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED2);
		...
		header('Content-Disposition: attachment;filename="EJECUCION_'.$fecha_m.'_RV.xls"');
