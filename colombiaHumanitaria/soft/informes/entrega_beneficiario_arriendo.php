<?php
	...
	if($logonSuccess){
		...
		$damnificados = array();	
		$result = Humanitaria::getInstance()->get_arriendos_atendidos_by_fase($fase);		
		...
		header('Content-Disposition: attachment;filename="F-CD-005-ENTREGA_A_BENEFICIARIO_ARRIENDO.xls"');
