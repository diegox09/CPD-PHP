<?php
	...
	if($logonSuccess){	
		...
		if($numeroFactura == ''){	
			...
			$consulta = Factura::getInstance()->insert_factura($idPrograma, $numeroFactura, $ciudad, $fecha, $fechaActual, $idCliente, $idUser, $idEstadoFactura, $tarifaIva, $tarifaRetencionIva, $retencionFuente, $impuestoRenta, $retencionIca, $ivaAsumido);
			...
			$consulta = Factura::getInstance()->update_factura($idPrograma, $numeroFactura, $ciudad, $fecha, $fechaActual, $idCliente, $idUser, $idEstadoFactura, $tarifaIva, $tarifaRetencionIva, $retencionFuente, $impuestoRenta, $retencionIca, $ivaAsumido);
		...
		if($consulta){
			...
			if(mysqli_num_rows($result) == 0)	
				...
				//Modificacion
				$respuesta['ivaAsumido'] = $factura['ivaAsumido'];
