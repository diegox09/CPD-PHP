...
while (mysql_num_rows($rs_select_c) > $contador_c){
	...
	$query_select = "SELECT * FROM deportista, tiempo_deportista WHERE tiempo_deportista.tiempo > 0 AND tiempo_deportista.id_deportista = deportista.id_deportista AND tiempo_deportista.year = ".$year." AND tiempo_deportista.id_categoria = ".$id_categoria." ORDER BY tiempo_deportista.tiempo";
...
$nombre = "CLASIFICACION CARRERA ATLETICA ".$year.".xlsx";
