...
<body>	
	...
	<div id="info">
        ...
        <div id="info_beneficiario" class="formulario" style="display:none">
			...
			<div id="psicologia" style="display:none">
				<div class="header_info">
					ATENCION PSICOLOGICA
					<label>
						&nbsp;&raquo;&nbsp;
						<span id="usuario_actualizo_psicologia"></span>                            
						&nbsp;&raquo;&nbsp;
						<span id="fecha_actualizacion_psicologia"></span> 
						&nbsp;
						<a href="#" id="actualizar_psicologia" class="actualizar" title="Actualizar">&nbsp;&nbsp;&nbsp;&nbsp;</a>
					</label>    
				</div>
				<div>
					<form id="form_psicologia" action="#" method="get">
						<input type="hidden" id="id_psicologia" name="id_psicologia" value="" />
						<input type="hidden" id="id_beneficiario_psicologia" name="id_beneficiario" value="" label="Seleccione un beneficiario"/>
						<input type="hidden" id="opc_psicologia" name="opc" value="" />
						<div style="width:100%">
							<div style="width:350px">
								<label>Nombre Beneficiario</label>
								<input type="text" name="nombre_beneficiario" id="nombre_beneficiario_psicologia" class="input_l" value="" readonly />
							</div> 	
							<div style="width:190px"> 
                                <label>Fecha Atencion</label><br>
                                <input type="text" name="fecha_atencion_psicologia" id="fecha_atencion_psicologia" class="input_c" value="" label="Digite la fecha de atencion" />                               
                            </div> 		
							<div style="width:210px"> 
								<label>Profesional</label><br>
								<select id="profesional_psicologia" class="select_l" name="profesional">
								</select>                               
							</div> 
							...
							<div style="width:991px" class="clear">
								...
								<textarea name="observaciones_psicologia" id="observaciones_psicologia" value="" ></textarea>        
							</div>
							<div style="width:991px" class="clear">
								<div class="header_diagnostico">
									<label>IMPRESION DIAGNOSTICA</label><br>
								</div>    
								<textarea name="impresion_diagnostica" id="impresion_diagnostica" value="" ></textarea>        
							</div>
							<div style="width:991px" class="clear">
								<div class="header_diagnostico">
									<label>PLAN DE INTERVENCION</label>
								</div>
								<textarea name="plan_intervencion" id="plan_intervencion" value="" ></textarea>        
							</div>
							
							<div id="botones_psicologia">
								<input type="button" id="eliminar_psicologia" class="boton_naranja" value="Eliminar" title="Eliminar Atencion Psicologica" style="display:none"/>
								&nbsp;&there4;&nbsp;
								<input type="submit" id="guardar_psicologia" class="boton_gris" value="Guardar" title="Guardar Atencion Psicologica"/>
								<input type="button" id="cancelar_psicologia" class="boton_naranja" value="Cancelar" title="Cancelar Atencion Psicologica"/>
								&nbsp;&there4;&nbsp;
								<input type="button" id="imprimir_psicologia" class="boton_azul" value="Imprimir" title="Imprimir Atencion Psicologica"/>
								&nbsp;	
							</div>
						</div>        
					</form>
				</div>
				<table id="tabla_psicologia" class="tablesorter"></table>
                <div class="espacio"></div>
			</div>          
            ...
            <form id="form_year" action="#" method="get">
                ...
                <div>
                    ...
                    <div id="botones_l">
						...
						<input type="button" id="ver_psicologia" class="boton_azul" value="Psicologia" title="Atencion Psicologica"/> 
                        &nbsp;&there4;&nbsp;
