<?php
	...
	if($logonSuccess){	
		...
		$pdf->Cell(80,7,$nombreBeneficiario,'B',0,'L');		
		$pdf->Cell(15);
		...
		$pdf->Cell(80,7,$direccion,'B',0,'L');		
		$pdf->Cell(15);
		$pdf->Cell(20,7,'Barrio:','',0,'L');
		$pdf->Cell(41,7,$nombreBarrio,'B',0,'L');
		$pdf->Cell(10,7,'','R',1);
		
		$pdf->Cell(20,7,'Familia:','L',0,'L');
		$pdf->Cell(80,7,'','B',0);		
		$pdf->Cell(15);
		...
		$pdf->Cell(80,7,$nombreAcudiente,'B',0,'L');		
		$pdf->Cell(15);
