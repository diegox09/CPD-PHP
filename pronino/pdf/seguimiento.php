<?php
	...
	if($logonSuccess){	
		...
		if(mysqli_num_rows($result) == 0){
			...
			$pdf->Cell(28,5,'FECHA',1,1,'C',1);
			$pdf->Cell(28,5,'DD/MM/AA',1,0,'C',1);
			$pdf->SetXY(43, 32);
			$pdf->Cell(65,10,'MOTIVO',1,0,'C',1);
			$pdf->Cell(123,10,utf8_decode('DESCRIPCIÓN'),1,0,'C',1);
			$pdf->Cell(34,5,'FIRMA DEL','TLR',2,'C',1);
			$pdf->Cell(34,5,'PROFESIONAL','LRB',1,'C',1);
