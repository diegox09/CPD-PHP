...
class Pronino extends mysqli {
	...
	*/
	...
	public function update_beneficiario_pronino($idBeneficiario, $item, $tallaUniforme, $tallaZapato, $sisben, $idArs, $idUsuario1, $idUsuario2, $fechaIngreso, $estado, $fechaRetiro, $razonRetiro, $idUser, $fechaActual, $razonEgresado, $razonBaja, $grupoEtnico, $tipologiaFamiliar, $parentescoAcudiente){
		...
		if($item == '')
        	return $this->query('UPDATE pronino_beneficiario SET item = NULL, tallaUniforme = "'.$tallaUniforme.'", tallaZapato = "'.$tallaZapato.'", sisben = "'.$sisben.'", idArs = "'.$idArs.'", idUsuario1 = "'.$idUsuario1.'", idUsuario2 = "'.$idUsuario2.'", fechaIngreso = "'.$fechaIngreso.'", estado = "'.$estado.'", fechaRetiro = "'.$fechaRetiro.'", razonRetiro = "'.$razonRetiro.'", fechaActualizacion = "'.$fechaActual.'", idUser = "'.$idUser.'", razonEgresado = "'.$razonEgresado.'", razonBaja = "'.$razonBaja.'", grupoEtnico = "'.$grupoEtnico.'", tipologiaFamiliar = "'.$tipologiaFamiliar.'", parentescoAcudiente = "'.$parentescoAcudiente.'" WHERE idBeneficiario = "'.$idBeneficiario.'"');
		else
	...
	*/
	...
	public function insert_beneficiario_year($idBeneficiario, $year, $sitioTrabajo, $actividadLaboral, $actividadEspecifica, $observaciones, $idMunicipio, $idColegio, $idSedeColegio, $grado, $jornada, $escuelaFormacion1, $escuelaFormacion2, $desplazados, $juntos, $familiasAccion, $comedorInfantil, $kitEscolar, $uniforme, $zapatos, $visitaDomiciliaria, $visitaPsicosocial, $visitaAcademica, $intervencionPsicologica, $valoracionMedica, $valoracionOdontologica, $idUser, $fechaActual, $seccion, $kitNutricional, $visitaSeguimiento, $actualmenteTrabaja, $problemaSalud, $ingresosMes, $gastaIngresos, $ingresosPercibidos, $porqueTrabaja, $situacionEspecial, $folioUnidos, $escolarizado, $ciclo){
		...
		$ingresosMes = $this->real_escape_string($ingresosMes);
		$folioUnidos = $this->real_escape_string($folioUnidos);
        return $this->query('INSERT INTO pronino_year (idBeneficiario, year, sitioTrabajo, actividadLaboral, actividadEspecifica, observaciones, idMunicipioColegio, idColegio, idSedeColegio, grado, jornada, escuelaFormacion1, escuelaFormacion2, desplazados, juntos, familiasAccion, comedorInfantil, kitEscolar, uniforme, zapatos, visitaDomiciliaria, visitaPsicosocial, visitaAcademica, intervencionPsicologica, valoracionMedica, valoracionOdontologica, idUser, fechaActualizacion, seccion, kitNutricional, visitaSeguimiento, actualmenteTrabaja, problemaSalud, ingresosMes, gastaIngresos, ingresosPercibidos, porqueTrabaja, situacionEspecial, folioUnidos, escolarizado, ciclo) VALUES("'.$idBeneficiario.'", "'.$year.'", "'.$sitioTrabajo.'", "'.$actividadLaboral.'", "'.$actividadEspecifica.'", "'.$observaciones.'", "'.$idMunicipio.'", "'.$idColegio.'", "'.$idSedeColegio.'", "'.$grado.'", "'.$jornada.'", "'.$escuelaFormacion1.'", "'.$escuelaFormacion2.'", "'.$desplazados.'", "'.$juntos.'", "'.$familiasAccion.'", "'.$comedorInfantil.'", "'.$kitEscolar.'", "'.$uniforme.'", "'.$zapatos.'", "'.$visitaDomiciliaria.'", "'.$visitaPsicosocial.'", "'.$visitaAcademica.'", "'.$intervencionPsicologica.'", "'.$valoracionMedica.'", "'.$valoracionOdontologica.'", "'.$idUser.'", "'.$fechaActual.'", "'.$seccion.'", "'.$kitNutricional.'", "'.$visitaSeguimiento.'", "'.$actualmenteTrabaja.'", "'.$problemaSalud.'", "'.$ingresosMes.'", "'.$gastaIngresos.'", "'.$ingresosPercibidos.'", "'.$porqueTrabaja.'", "'.$situacionEspecial.'", "'.$folioUnidos.'", "'.$escolarizado.'", "'.$ciclo.'")');
    }
